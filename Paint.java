...
public class Paint extends Application {
    ...
    private double middle = .5; //This is for the middle of the scroll wheel.
    
    //These are the values I'm using for the line width controller. 
    ...
    //The program will be have autosave disabled by default.
    private int autoSaveInterval = 0;
    private int currentTimeLeft = 0;
    private boolean autoSaveVisible = false;
    ...
    /**
     * Clears the redo Stack, then saves the current graphics context (gc) to the undo Stack.
     */
    public void save(){
    redoStack.clear();
    ...
    /**
     * If there is something to undo, add the current canvas to the redo stack, clear the screen,
     * and draw the last item in the undo stack to the screen.
     */
    public void undo(){
    ...
    /**
     * If there is something to redo, add current canvas to undo stack, clear the screen,
     * and draw the last item in the redo stack to the screen.
     */
    public void redo(){
     ...
     * and height, and drawing the saved canvas to the now resized screen
     * @param x
     * @param y
     */
    ...
    public FileChooser filePickerSetup(String fileChooserTitle){
        ...
        FileChooser.ExtensionFilter extFilter1 = new FileChooser.ExtensionFilter("Image files", "*.png","*.jpg","*.bmp");
    ...
    public void autoSaveHandle(){
        ...
        autosaveLabelKF = new KeyFrame(Duration.seconds(1), (ActionEvent event) -> {
            if (!(autoSaveVisible) && (autoSaveInterval < 1) && (currentTimeLeft > 0)){
                currentTimeLeft--;
    ...
    public void start(Stage stage) throws Exception {
        fh = new FileHandler("C:/Users/Owner/Downloads/Paint-copy-copy.log",true);  
    ...
    toolSelectionGrid.add(createBtnImage(btnSize,"C:/Users/Owner/Downloads/Paint/pencil.png","Pencil")   , 0, 0);
    toolSelectionGrid.add(createBtnImage(btnSize,"C:/Users/Owner/Downloads/Paint/line.png","Line")       , 1, 0);
    toolSelectionGrid.add(createBtnImage(btnSize,"C:/Users/Owner/Downloads/Paint/select.png","Select")   , 0, 1);
    toolSelectionGrid.add(createBtnImage(btnSize,"C:/Users/Owner/Downloads/Paint/move.png","Move")       , 1, 1);
    toolSelectionGrid.add(createBtnImage(btnSize,"C:/Users/Owner/Downloads/Paint/dropper.png","Dropper") , 0, 2);
    toolSelectionGrid.add(createBtnImage(btnSize,"C:/Users/Owner/Downloads/Paint/eraser.png","Eraser"),    1, 2);
    toolSelectionGrid.add(createBtnImage(btnSize,"C:/Users/Owner/Downloads/Paint/square.png","Rectangle"), 0, 3);
    toolSelectionGrid.add(createBtnImage(btnSize,"C:/Users/Owner/Downloads/Paint/circle.png","Circle"),    1, 3);
    toolSelectionGrid.add(createBtnImage(btnSize,"C:/Users/Owner/Downloads/Paint/text.png","Text"),        0, 4);
    toolSelectionGrid.add(createBtnImage(btnSize,"C:/Users/Owner/Downloads/Paint/polygon.png","Polygon"),  1, 4);
    toolSelectionGrid.add(createBtnImage(btnSize,"C:/Users/Owner/Downloads/Paint/triangle.png","Triangle"),0, 5);
    toolSelectionGrid.add(createBtnImage(btnSize,"C:/Users/Owner/Downloads/Paint/none.png","No Tool"),     0, 6);
    ...
    //It's a stackpane wrapped in a scrollpane so that it stays centered.
    ...
    //This sets the initial value of the scrollbars. .5 for 50% (the middle).
    scrollPane.setHvalue(middle);
    scrollPane.setVvalue(middle);
